...
# Ignore 429 errors (Too Many Requests)
linkcheck_ignore = [
    'https://developer.hashicorp.com/consul',  # Temporarily ignore this URL due to rate limiting
    'https://www.f5.com/pdf/solution-profiles/fix-solution-profile.pdf',  # Ignore this URL due to 308 redirect
    'https://community.f5.com/kb/technicalarticles/accessing-tcp-options-from-irules/287183' # Currently has a redirect and cannot be handled
]
