...
describe('patch', function () {
    ...
    it('should patch virtual server addresses and enable', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/Tenant', [
                {
                    op: 'add',
    ...
    it('should patch pool members', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => {
                ...
                return patch('/mgmt/shared/appsvcs/declare/Tenant', [
                    {
                        op: 'add',
                        path: `${testNode1}`,
                        value: {
    ...
    it('should patch replacing an attached iRule', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/TEST_IRULES_EXPAND', [
                {
                    op: 'replace',
    ...
    it('should patch TCP profile', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/TEST_TCP_PROFILE', [
                {
                    op: 'replace',
    ...
    it('should patch virtual server port', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/TEST_Service_HTTP', [
                {
                    op: 'replace',
    ...
    it('should patch service addresses', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/TEST_SERVICE_ADDRESS', [
                {
                    op: 'replace',
    ...
    it('should patch switching certificates', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare/TEST_MONITOR_HTTPS', [
                {
                    op: 'remove',
    ...
    it('should patch a new tenant into place', () => {
        ...
        return Promise.resolve()
            ...
            .then(() => patch('/mgmt/shared/appsvcs/declare', [
                {
                    op: 'add',
                    path: '/Tenant3',
                    value: {
