...
describe('map_mcp', () => {
    ...
    describe('tm:api-protection:response:responsestate', () => {
        it('should return api-protection response with mostly default values', () => {
            const obj = {
                kind: 'tm:api-protection:response:responsestate',
                name: 'response1',
                partition: 'Tenant',
                subPath: 'App',
                fullPath: '/Tenant/App/response1',
                generation: 12416,
                selfLink: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response1?ver=16.1.3.1',
                statusCode: '403',
                statusString: 'Forbidden',
                headersReference: {
                    link: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response1/headers?ver=16.1.3.1',
                    isSubcollection: true
                }
            };
            const referenceConfig = [];
        ...
        it('should return api-protection response with all custom values', () => {
            const obj = {
                kind: 'tm:api-protection:response:responsestate',
                name: 'response2',
                partition: 'Tenant',
                subPath: 'App',
                fullPath: '/Tenant/App/response2',
                generation: 12416,
                selfLink: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response2?ver=16.1.3.1',
                ...
                headersReference: {
                    link: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response2/headers?ver=16.1.3.1',
                    isSubcollection: true
                }
            };
            const referenceConfig = [
                {
                    kind: 'tm:api-protection:response:headers:headersstate',
                    name: '0',
                    fullPath: '0',
                    generation: 3332,
                    selfLink: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response2/headers/0?ver=16.1.3.1',
                ...
                },
                {
                    ...
                    fullPath: '1',
                    generation: 3332,
                    selfLink: 'https://localhost/mgmt/tm/api-protection/response/~Tenant~App~response2/headers/1?ver=16.1.3.1',
                    headerName: 'foo',
                    headerValue: 'bar'
                }
            ];
